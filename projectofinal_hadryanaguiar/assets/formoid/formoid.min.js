var Formoid = (function () {
    // URL da API para envio de dados do formulário
    var API_URL = 'https://formoid.net/api/push';

    // Função AJAX personalizada para fazer requisições ao servidor
    function $ajax(url, settings) {
        return new Promise(function (resolve, reject) {
            var xhr = new XMLHttpRequest();
            xhr.open(settings.type, url);
            xhr.onload = function () {
                // Verifica se a resposta do servidor está correta
                if (xhr.status !== 200) {
    ...
    // Função para obter um atributo do formulário
    ...
    // Métodos para definir ou obter o email, título e dados do formulário
    ...
    // Retorna uma instância do formulário
    return {
...
// Inicializa o modal se o Bootstrap estiver disponível
if (bootstrap) {
...
// Seleciona todos os componentes do formulário
var formComponents = document.querySelectorAll('[data-form-type="formoid"]');

// Itera sobre cada componente do formulário e adiciona funcionalidades
formComponents.forEach(function (component) {
    ...
    // Adiciona listener para mudança nos inputs, verifica o tamanho do arquivo
    ...
    form.addEventListener('submit', function (event) {
        ...
        // Promise para processar e enviar os dados do formulário
        Promise
